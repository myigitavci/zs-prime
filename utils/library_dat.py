...
class data_generator(tf.keras.utils.Sequence):
    ...
    def __init__(self, kdata_all, csm, mask_trn1, mask_trn2, mask_lss1, mask_lss2, b0_map ):
    ...
    def __getitem__(self, index):
        ...
        # Generate data
        C, K_trn1, K_trn2, K_lss1, K_lss2, m_trn1, m_trn2, m_lss1, m_lss2, Fm = self.__data_generation(indexes)
        return [C, K_trn1, K_trn2, K_lss1, K_lss2, m_trn1, m_trn2, m_lss1, m_lss2, Fm], [np.zeros(1,)]
    ...
    def __data_generation(self, indexes):
        ...
        Fm      =   np.copy(self.field[I_bat:I_bat+1,])
        ...
        return C, K_trn1, K_trn2, K_lss1, K_lss2, m_trn1, m_trn2, m_lss1, m_lss2, Fm
