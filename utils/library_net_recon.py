...
class myDC(Layer):
    ...
    def __init__(self, **kwargs):
        ...
        self.lam1 = self.add_weight(name='lam1', shape=(1,), initializer=tf.constant_initializer(value=0.01),
                                     dtype='float32', trainable=True)
        self.lam2 = self.add_weight(name='lam2', shape=(1,), initializer=tf.constant_initializer(value=0.01),
                                     dtype='float32', trainable=True)
    ...
    def call(self, x):
        ...
        def backward1(tmp1):
            ...
            def backward2(tmp2):
                ...
                # ----ask---- how does field map works here?
...
def create_recon(nx, ny, nc, nLayers, num_block, virtual_coil, num_filters = 64,  esp = 0):
    ...
    # ----ask---- if this is correct? and should there be another step later to "un"conjugate?
